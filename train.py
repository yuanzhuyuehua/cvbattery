...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default="C:/Users/pc/yolov5/models/yolov5s.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default="C:/Users/pc/yolov5/models/yolov5s.yaml", help="model.yaml path")
    parser.add_argument("--data", type=str, default= "C:/Users/pc/yolov5/data/mydata.yaml", help="dataset.yaml path")
    parser.add_argument("--hyp", type=str, default="C:/Users/pc/yolov5/data/hyps/hyp.scratch-low.yaml", help="hyperparameters path")
