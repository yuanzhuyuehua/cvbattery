...
def run(
    weights="C:/Users/pc/yolov5/runs/train/exp5/weights/best.pt",  # model path or triton URL
    source="D:/cv/data1",  # file/dir/URL/glob/screen/0(webcam)
    data="C:/Users/pc/yolov5/data/mydata.yaml",  # dataset.yaml path
...
def parse_opt():
    ...
    parser.add_argument("--weights", nargs="+", type=str, default="C:/Users/pc/yolov5/runs/train/exp15/weights/best.pt", help="model path or triton URL")
    parser.add_argument("--source", type=str, default="D:/cv/shibiedata4", help="file/dir/URL/glob/screen/0(webcam)")
    parser.add_argument("--data", type=str, default="C:/Users/pc/yolov5/data/mydata.yaml", help="(optional) dataset.yaml path")
